    ...
    >
      <div className="max-w-[1280px] mx-auto px-8 h-[68px] flex items-center justify-between gap-6">
        ...
        <div className="hidden min-[900px]:flex items-center gap-2.5">
          ...
          <a
            href="#fees"
            className="inline-flex items-center bg-primary text-white px-[18px] py-2 rounded-[7px] no-underline text-[13px] font-semibold whitespace-nowrap transition-all duration-200 hover:bg-primary-hover shadow-[0_2px_10px_rgba(46,204,113,0.28)] hover:shadow-[0_4px_16px_rgba(46,204,113,0.4)]"
          >
            Register Now
          </a>
        </div>
        ...
        <div className="min-[900px]:hidden bg-white border-t border-primary-faint px-8 py-4 pb-6">
          ...
          <div className="flex flex-col gap-2.5 mt-4">
            ...
            <a
              href="#fees"
              onClick={() => setMobileOpen(false)}
              className="block bg-primary text-white py-2.5 px-5 rounded-[7px] no-underline text-sm font-semibold text-center"
            >
              Register Now
            </a>
          </div>
